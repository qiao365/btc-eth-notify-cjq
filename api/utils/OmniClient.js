...
Omni.init = function (user, pass, otherip, port) {
    var host;
...
Omni.getbalance = function (address, confirmations, cb) {
    client.cmd('getbalance', address, confirmations, function (err, balance, resHeaders) {
        if (err) return console.log(err)
